...
public class Bienvenido extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Titulo.setText("Bienvenido al extractor de jugo");

        jButton1.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jButton1.setText("Configurar Jugo");
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Configurar_Jugo_ActionPerformed(evt);
            }
        });
    ...
    private void Configurar_Jugo_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Configurar_Jugo_ActionPerformed
        this.setVisible(false);
        new Menu().setVisible(true);
    }//GEN-LAST:event_Configurar_Jugo_ActionPerformed
